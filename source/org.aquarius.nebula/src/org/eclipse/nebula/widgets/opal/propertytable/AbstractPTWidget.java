...
public abstract class AbstractPTWidget implements PTWidget {
	...
	public PTWidget build() {
		...
		if (this.parentPropertyTable.showButtons) {
			buildButtons(parent, this.parentPropertyTable.sorted, //
					this.parentPropertyTable.styleOfView == PropertyTable.VIEW_AS_CATEGORIES, //
					this.parentPropertyTable.showDescription);
		}
	...
	private void buildDescriptionPanel(final Composite parent) {
		this.descriptionLabel = new StyledText(parent, SWT.READ_ONLY | SWT.WRAP | SWT.V_SCROLL);
