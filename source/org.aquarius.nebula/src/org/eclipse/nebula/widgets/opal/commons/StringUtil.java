...
public class StringUtil {
	...
	/**
	 * Returns a "safe" string representation. If source is null, return an empty
	 * string
	 *
	 * @param source source string
	 * @return the string representation of the source (without space) if the source
	 ...
	 *
	 * @param source source string
	 * @return <code>true</code> is the string is empty or null, <code>false</code>
	 *         otherwise
	 */
