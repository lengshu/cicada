...
public interface IBrowserDescriptorWorkingCopy extends IBrowserDescriptor {
	/**
	 * Renames this browser to the specified name. The new name cannot be
	 * <code>null</code>.
	 *
	...
	/**
	 * Set the location of this browsers executable. The location must not be
	 * <code>null</code>.
	 *
	...
	/**
	 * Set the parameters for this browser. If there are no parameters, the
