...
public interface IBrowserDescriptor {
	...
	/**
	 * Returns the parameters that should be used to launch the Web browser
	 * executable. %URL% is used if the URL should be inserted into the parameters.
	 * If there are no parameters, <code>null</code> is returned.
	 *
	 ...
	 * This method has no effect if the browser has already been deleted or has
	 * never been saved.
	 */
	public void delete();
