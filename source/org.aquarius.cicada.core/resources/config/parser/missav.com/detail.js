...
function internalParseMovieDetailInfo() {
	...
	var infoElement = document.querySelector("div.space-y-2");
	...
	if (null != infoElement) {
		...
		var uniIdElement = infoChildrenElements[1].lastElementChild;
		
		var actorElement = infoChildrenElements[2];
		var categoryElement = infoChildrenElements[3];
		var producerElement = infoChildrenElements[5];
		var tagElement = infoChildrenElements[infoChildrenElements.length - 1];
		...
		try {
			...
			link.refererUrl="https://video.missav.com/";
			link.hls=true;
